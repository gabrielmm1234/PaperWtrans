...
O arquivo de dados da CEAP no ano de 2017 possui um total de 209496 transações, o carregamento total dessas transações levou cerca de 16 horas em um notebook com Ubuntu 16-04 LTS, Intel Core i5-5200U CPU 2.20GHz * 4 e 6 Gb de RAM.
...
Os resultados mostram como é intuitivo interpretar os dados olhando para a estrutura de um grafo, em vez de analisar uma tabela. Isso coloca os bancos de dados em grafos como ótima opção para aplicações que tem por objetivo a transparência e interpretação de dados complexos e bastante relacionados.
